...
map.getView().fit([9812248.518026, 2705013.880717, 9817601.188848, 2707756.027655], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GAMA INDEX</h2>';
        return titleElement;
    })(),
